...
export async function postATask(req: Request, res: Response, next: NextFunction) {
  try {
...
export async function getTaskWithID(req: Request, res: Response, next: NextFunction) {
  try {
    const db = getDB();
    const { id } = req.params;
...
export async function updateTaskWithID(req: Request, res: Response, next: NextFunction) {
  try {
...
export async function deleteTaskWithID(req: Request, res: Response, next: NextFunction) {
  try {
    const db = getDB();
    const { id } = req.params;
    const task = await db.get('SELECT * FROM tasks WHERE id = ?', id);
